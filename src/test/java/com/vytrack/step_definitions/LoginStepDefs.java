...
public class LoginStepDefs {
    ...
    public void the_user_enters_the_information(String string) {
        String username = string + "_username";
        String pass = string + "_password";
        BrowserUtils.waitFor(3);
        new LoginPage().login(ConfigurationReader.get(username), ConfigurationReader.get(pass));
        }
